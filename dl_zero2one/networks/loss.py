...
import pickle
import numpy as np
from dl_zero2one.networks.linear_model import *
...
class L1(Loss):
    ...
    def forward(self, y_out, y_truth):
        ...
        Returns:
            loss: [N, ] array of L1 loss for each sample of your training set.
        """
        result = None
    ...
    def backward(self, y_out, y_truth):
        ...
        Args:
            ...
            y_truth: [N, ] array ground truth value of your training set.
        Returns:
            gradient: [N, ] array of L1 loss gradients w.r.t y_out for
...
class MSE(Loss):
    ...
    def forward(self, y_out, y_truth):
        ...
        Args:
            ...
            y_truth: [N, ] array ground truth value of your training set.
        Returns:
            loss: [N, ] array of MSE loss for each sample of your training set.
        """
        result = None
    ...
    def backward(self, y_out, y_truth):
        ...
        Args:
            ...
            y_truth: [N, ] array ground truth value of your training set.
        Returns:
            gradient: [N, ] array of MSE loss gradients w.r.t y_out for
            each sample of your training set.
        """
        gradient = None
...
class BCE(Loss):
    ...
    def forward(self, y_out, y_truth):
        ...
        Args: 
            ...
            y_truth: [N, ] array ground truth value of your training set.
        Returns:
            loss: [N, ] array of binary cross entropy loss for each sample of your training set.
        """
    ...
    def backward(self, y_out, y_truth):
        ...
        Args: 
            ...
            y_truth: [N, ] array ground truth value of your training set.
        Returns:
            gradient: [N, ] array of binary cross entropy loss gradients w.r.t y_out for
            each sample of your training set.
        """
...
class CrossEntropyFromLogits(Loss):
    ...
    def forward(self, y_out, y_truth, reduction='mean'):
        ...
        :param y_truth: [N, C] array with ground truth labels.
