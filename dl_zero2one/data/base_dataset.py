...
class Dataset(ABC):
    ...
    def __init__(self, root, download_url=None, force_download=False, verbose=False):
        ...
        Args:
            root: path to the directory where the dataset will be stored
...
class DummyDataset(Dataset):
    ...
    def __init__(self, divisor, limit, **kwargs):
        """
        Args:
            divisor: common divisor of all integers in the dataset
            limit: upper limit of integers in the dataset
        """
