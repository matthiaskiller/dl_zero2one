...
from dl_zero2one.networks.optimizer import Optimizer
...
class Solver(object):
    ...
    To train a model, we will first construct a Solver instance, passing the
    model, dataset, learning_rate to the constructor.
    We will then call the train() method to run the optimization
